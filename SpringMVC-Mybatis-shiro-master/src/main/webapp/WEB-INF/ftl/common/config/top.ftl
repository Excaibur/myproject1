	          ...
	          <ul class="nav navbar-nav" id="topMenu">
				<li class="dropdown ${(index==1)?string('active','')}">
					...
					<ul class="dropdown-menu">
						<li><a href="http://localhost:8080/shiro.demo/user/index.shtml">个人资料</a></li>
						<li><a href="http://localhost:8080/shiro.demo/user/updateSelf.shtml" >资料修改</a></li>
						<li><a href="http://localhost:8080/shiro.demo/user/updatePswd.shtml" >密码修改</a></li>
						<li><a href="http://localhost:8080/shiro.demo/role/mypermission.shtml">我的权限</a></li>
					</ul>
				</li>	  
				...
				<li class="dropdown ${(index==2)?string('active','')}">
					...
					<ul class="dropdown-menu">
						<@shiro.hasPermission name="/member/list.shtml">
							<li><a href="http://localhost:8080/shiro.demo/member/list.shtml">用户列表</a></li>
						</@shiro.hasPermission>
						<@shiro.hasPermission name="/member/online.shtml">
							<li><a href="http://localhost:8080/shiro.demo/member/online.shtml">在线用户</a></li>
						</@shiro.hasPermission>
					</ul>
				</li>	
				</@shiro.hasAnyRoles>         
					...
					<li class="dropdown ${(index==3)?string('active','')}">
						...
						<ul class="dropdown-menu">
							<@shiro.hasPermission name="/role/index.shtml">
								<li><a href="http://localhost:8080/shiro.demo/role/index.shtml">角色列表</a></li>
							</@shiro.hasPermission>
							<@shiro.hasPermission name="/role/allocation.shtml">
								<li><a href="http://localhost:8080/shiro.demo/role/allocation.shtml">角色分配</a></li>
							</@shiro.hasPermission>
							<@shiro.hasPermission name="/permission/index.shtml">
								<li><a href="http://localhost:8080/shiro.demo/permission/index.shtml">权限列表</a></li>
							</@shiro.hasPermission>
							<@shiro.hasPermission name="/permission/allocation.shtml">
								<li><a href="http://localhost:8080/shiro.demo/permission/allocation.shtml">权限分配</a></li>
							</@shiro.hasPermission>
						</ul>
					</li>	
				</@shiro.hasAnyRoles>    
	           ...
	           <ul class="nav navbar-nav  pull-right" >
				<li class="dropdown ${(index==10)?string('active','')}" style="color:#fff;">
					<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown"  
						<@shiro.user>  
							onclick="location.href='http://localhost:8080/shiro.demo/user/index.shtml'" href="http://localhost:8080/shiro.demo/user/index.shtml" class="dropdown-toggle qqlogin" >
						...
						<@shiro.guest>   
							 href="javascript:void(0);" onclick="location.href='http://localhost:8080/shiro.demo/u/login.shtml'" class="dropdown-toggle qqlogin" >
