...
<html lang="zh-cn">
	<head>
		...
		<link href="http://localhost:8080/shiro.demo/js/common/bootstrap/3.3.5/css/bootstrap.min.css?${_v}" rel="stylesheet"/>
		<link href="http://localhost:8080/shiro.demo/css/common/base.css?${_v}" rel="stylesheet"/>
		<script  src="http://open.sojson.com/common/jquery/jquery1.8.3.min.js"></script>
		<script  src="http://localhost:8080/shiro.demo/js/common/layer/layer.js"></script>
		<script  src="http://localhost:8080/shiro.demo/js/common/bootstrap/3.3.5/js/bootstrap.min.js"></script>
		<script >
		/*
